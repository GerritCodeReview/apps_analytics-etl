...
class ElasticSearchPimpedWriterIT
  ...
  "Test creating a new index and alias" should "create new index" ignore {
    ...
    dataIntoIndexOne.saveToEsWithAliasSwap(aliasName, document) onSuccess {
      case _ =>
    ...
    dataIntoIndexTwo.saveToEsWithAliasSwap(aliasName, document) onSuccess {
      case _ =>
        // Reading from the alias
