...
class ElasticSearcPimpedhWriterIT extends FlatSpec with Matchers with SparkTestSupport {
  "Test creating a new index and alias" should "create new index" in {
    ...
    val resultFromAliasFirst: Dataset[String] =
      spark.read.format("es").load("the_alias/doc").as[String]
