...
sealed trait GerritChangeBasedEvent extends GerritJsonEvent {
...
sealed trait RepositoryModifiedGerritEvent {
...
case class ChangeMergedEvent(
                            ...
                            ) extends GerritChangeBasedEvent with RepositoryModifiedGerritEvent {
...
case class RefUpdatedEvent(
                            ...
                            submitter: GerritAccount,
                            override val eventCreatedOn: Long
                          ) extends GerritJsonEvent with RepositoryModifiedGerritEvent {
