...
class SparkExtractorsSpec extends FlatSpec with Matchers {
  ...
  it should "throw an exception for an unexpected access path" in {
    val what = s"any"
    val accessPath = "unexpected"

    assertThrows[IllegalArgumentException] {
      SparkExtractors.extractCommand(what, accessPath)
    }
  }
  ...
  it should "throw an exception for an unexpected access path" in {
    ...
    assertThrows[IllegalArgumentException] {
      SparkExtractors.extractCommandArguments(what, accessPath)
    }
  }
